"""
================================================================================
PART 8 INSTITUTIONAL WALK-FORWARD PROGRESSION: WINDOWS 1 THROUGH 9
================================================================================
Extends `verify_sequential_w1_w8.py` with Window 9 (Multi-Strategy Confluence & Confirmation) (FTX cycle bottom + Jan 2023
...
# ─────────────────────────────────────────────────────────────────────────────
print("\n" + "=" * 120)
print("PART 8 SEQUENTIAL WALK-FORWARD PROGRESSION: WINDOWS 1 THROUGH 8")
print("=" * 120)
...
# ─────────────────────────────────────────────────────────────────────────────
print("=" * 120)
print(f"SUMMARY: {passes}/9 Windows Verified Passed ({passes/9.0*100:.1f}%) with Zero Regressions Under Strict Part 8 Protocol.")
print("=" * 120)
...
audit_path = os.path.join(os.path.dirname(__file__) if '__file__' in locals() else '.', 'w8_causal_audit.json')
