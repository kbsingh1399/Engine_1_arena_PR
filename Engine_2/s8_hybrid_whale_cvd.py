"""
================================================================================
ENGINE 2: S8 HYBRID STRATEGY (CVD MOMENTUM + WHALE/RETAIL FEATURES)
================================================================================
Hybrid Strategy combining S2's proven momentum archetypes with S8's whale 
features for enhanced signal quality:
  1. S2's 12 Proven Momentum/Breakout/Reversal Archetypes
  2. S8's Whale vs Retail Divergence Features (Top Trader LS Ratio, Whale Index)
...
RESULTS_DIR = os.path.join(SCRIPT_DIR, "results_s8_hybrid")
...
def load_and_preprocess_data():
    ...
    logger.info("Loading 18-asset historical parquet datasets for S8 Hybrid (CVD Momentum + Whale)...")
    ...
    logger.info(f"Loaded Clean Partitioned Datasets for S8 Hybrid: {total_rows:,} rows across {len(data_by_symbol)} symbols")
...
def run_autonomous_loop():
    ...
    logger.info("Initializing Autonomous 20-Window OOS Optimization Loop for S8 Hybrid (CVD Momentum)...")
    ...
    if success:
        ...
        with open(result_path, "w") as f:
            json.dump({
                "strategy": "S8_Hybrid_CVD_Momentum_Whale",
                "horizon_months": 18,
                "concurrency": 2,
                "leverage": 10.0,
        ...
        print("\n" + "="*80, flush=True)
        print("🏆 S8 HYBRID CONQUERED — ALL 20 WINDOWS PASSED", flush=True)
        print("="*80 + "\n", flush=True)
