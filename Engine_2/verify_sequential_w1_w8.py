"""
================================================================================
PART 8 INSTITUTIONAL WALK-FORWARD PROGRESSION: WINDOWS 1 THROUGH 8
================================================================================
Extends `verify_sequential_w1_w7.py` with Window 8 (FTX cycle bottom + Jan 2023
...
# ─────────────────────────────────────────────────────────────────────────────
print("=" * 120)
print(f"SUMMARY: {passes}/8 Windows Verified Passed ({passes/8.0*100:.1f}%) with Zero Regressions Under Strict Part 8 Protocol.")
print("=" * 120)
