...
def evaluate_dual_model_matrix():
    strat_loaders = {
    ...
    for w in windows:
        ...
        for s_name, df_s in strategies.items():
            ...
            # Test both standard target (>=1.0R) and runner target (>=1.5R):
            for label_r_thresh in [1.0, 1.5]:
    ...
    print("="*105)
    print(f"DUAL-MODEL REGIME MATRIX PASS RATE: {passes}/20 ({passes/20*100:.1f}%)")
    print("="*105)

if __name__ == "__main__":
    evaluate_dual_model_matrix()
