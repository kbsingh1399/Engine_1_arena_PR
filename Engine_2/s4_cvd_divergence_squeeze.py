"""
================================================================================
ENGINE 2: S4 CVD DIVERGENCE & SQUEEZE STRATEGY
================================================================================
Autonomous ML Strategy Engine with:
  1. Spot-Futures CVD Divergence with Volatility Squeeze Detection
  2. Proven Momentum Archetypes with CVD divergence between spot and futures markets
...
RESULTS_DIR = os.path.join(SCRIPT_DIR, "results_s4_cvd_divergence_squeeze")
...
def load_and_preprocess_data():
    ...
    logger.info("Loading 18-asset historical parquet datasets for S4 (CVD divergence between spot and futures markets)...")
...
def run_all_20_windows(data_by_symbol):
    ...
    # S4 uses S2's proven feature set (CVD divergence between spot and futures markets features computed but not in model)
    feature_cols = [
    ...
    logger.info("Extracting candidate trade streams for CVD divergence between spot and futures markets archetypes...")
    t0_ext = time.time()
    archetype_datasets = {}
    ...
    logger.info("🎉 PASSED ALL 20 OUT-OF-SAMPLE WINDOWS SEQUENTIALLY FOR S4!")
    return True
...
def run_autonomous_loop():
    ...
    logger.info("Initializing Autonomous 20-Window OOS Optimization Loop for S4 (CVD divergence between spot and futures markets)...")
    ...
    if success:
        ...
        with open(result_path, "w") as f:
            json.dump({
                "strategy": "S4_CVD_divergence_between_spot_and_futures_markets",
                "horizon_months": 18,
                "concurrency": 2,
                "leverage": 10.0,
