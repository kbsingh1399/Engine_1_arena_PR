...
def run_pooled_archetype_pipeline():
    btc_ref = get_btc_ref()
    ...
    # Unified Candidate Signal Generator (combining top 4 high-win-rate archetypes)
    all_trades = []
    ...
    print(f"Extracted {len(df_all):,} unified candidate trades.")
    ...
    print(f"\n[Pooled Unified Pipeline Result] -> {passes}/20 PASSED")
    for r in results:
