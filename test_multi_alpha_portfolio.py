...
def run_multi_alpha_test():
    ...
    for sym, df in dfs.items():
        ...
        # 1. Bull Momentum: Pullback in trend with CVD relative strength
    ...
    print(f"Extracted {len(df_all):,} multi-alpha candidate trades.")
    ...
    for wi, (test_start_str, test_end_str) in enumerate(OOS_MONTHS):
        ...
        # In-sample validation to pick optimal threshold
        ...
        # Select top K trades with probability floor
    ...
    print(f"\n[Multi-Alpha Portfolio Result] -> {passes}/20 PASSED")
    for r in results:
