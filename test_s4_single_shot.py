...
S4_WINDOW_CONFIGURATIONS = {
    1:  ("MR8_CVDDivergenceReversion",  0.56, 30.0, 180.0, 75.0),
    2:  ("MR11_VolExpansionReversion",  0.50, 30.0, 240.0, 90.0),
    3:  ("MR9_RelativeCVDReversion",    0.50, 120.0, 200.0, 60.0),
    4:  ("MR8_CVDDivergenceReversion",  0.50, 30.0, 220.0, 90.0),
    5:  ("MR5_LiqVoidSnapback",         0.48, 30.0, 220.0, 90.0),
    6:  ("MR13_DeepValueReversion",     0.52, 30.0, 220.0, 90.0),
    7:  ("MR11_VolExpansionReversion",  0.44, 30.0, 220.0, 90.0),
    8:  ("MR4_LiqExhaustionReversion",  0.52, 30.0, 180.0, 90.0),
    9:  ("MR4_LiqExhaustionReversion",  0.50, 30.0, 200.0, 50.0),
    10: ("MR11_VolExpansionReversion",  0.50, 30.0, 200.0, 90.0),
    11: ("MR9_RelativeCVDReversion",    0.52, 50.0, 180.0, 60.0),
    12: ("MR9_RelativeCVDReversion",    0.54, 30.0, 180.0, 75.0),
    13: ("MR14_SpotDeltaReversion",     0.50, 30.0, 240.0, 90.0),
    14: ("MR9_RelativeCVDReversion",    0.54, 50.0, 220.0, 75.0),
    15: ("MR11_VolExpansionReversion",  0.56, 30.0, 180.0, 90.0),
    16: ("MR13_DeepValueReversion",     0.44, 30.0, 180.0, 90.0),
    17: ("MR15_BearRallyReversion",     0.46, 100.0, 200.0, 90.0),
    18: ("MR4_LiqExhaustionReversion",  0.48, 100.0, 220.0, 50.0),
    19: ("MR4_LiqExhaustionReversion",  0.44, 30.0, 240.0, 50.0),
    20: ("MR3_ModerateRSIReversion",    0.44, 50.0, 180.0, 50.0)
}

def test_s4_single_shot():
    extracted = {}
    for fp in glob.glob(os.path.join(CACHE_DIR_S4, "*.parquet")):
