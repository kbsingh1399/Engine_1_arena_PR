...
from extract_s4_cache import featurize_df, get_btc_ref, gen_symbol_trades, DATA_DIR
...
# S4 Mean Reversion Archetypes
S4_ARCHETYPES_LIBRARY = {
...
def run_s4_test():
    ...
    print("Featurized all datasets for S4.")
    ...
    for name in needed:
        sig_fn = S4_ARCHETYPES_LIBRARY[name]
