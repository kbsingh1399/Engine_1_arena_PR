...
def test_s3_single_shot():
    extracted = {}
    for fp in glob.glob(os.path.join(CACHE_DIR_S3, "*.parquet")):
    ...
    print("\n" + "="*80)
    print("STRATEGY S3 (MACRO TREND FOLLOW) ZERO LOOKAHEAD WALK-FORWARD EVALUATION")
    print("="*80)
    ...
    for wi, (test_start_str, test_end_str) in enumerate(OOS_MONTHS):
        ...
        arch_name, th, ht, hr, br = S3_WINDOW_CONFIGURATIONS[w_num]
    ...
    print(f"\n=======================================================")
    print(f"Total Passing Windows for Strategy S3: {len(passed_windows)}/20")
    print(f"=======================================================")
